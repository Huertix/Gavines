...
public class TresCantosBuhardillaActivity extends Activity {

    private DatabaseHelper databaseHelper;
    private List<Event> events = new ArrayList<>();
    private EventAdapter adapter3CantosBuhardilla;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        events = databaseHelper.getAllEventsByLocation(LocationsEnum.TRESCANTOS_BUHARDILLA.location());

        adapter3CantosBuhardilla = new EventAdapter(this,R.layout.location_list_view, events);

        ListView listEvents = (ListView) findViewById(R.id.list_view);

        listEvents.setAdapter(adapter3CantosBuhardilla);
